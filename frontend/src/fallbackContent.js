  ...
  "blogPosts": [
    {
      ...
      "excerpt": "Les points simples a donner pour avoir une aide rapide sur un tableau ou un fichier Excel.",
      "readTime": "4 min",
      "imagePath": "/images/pexels-kampus-7983612.jpg",
      "intro": "Quand vous demandez une aide sur Excel, il faut dire clairement ce que vous voulez. Cela permet d'aller plus vite.",
      "sections": [
        {
          "title": "1. Dire le resultat voulu",
          "body": "Dites d'abord ce que vous voulez avoir a la fin: un total, un pourcentage, un tableau propre ou un graphique."
        },
        {
          "title": "2. Montrer ou ca bloque",
          "body": "Expliquez si le probleme vient d'une formule, d'un filtre, d'un tri ou simplement d'un tableau mal range."
        },
        {
          "title": "3. Dire quand il le faut",
          "body": "Si c'est pour aujourd'hui, pour demain ou pour plus tard, dites-le. Le delai aide a bien organiser la reponse."
        }
      ],
      "takeaway": "Plus votre demande est simple et precise, plus l'aide sera rapide."
    },
    {
      "id": "ia-bon-outil",
      "category": "IA",
      "title": "Quel outil IA choisir ?",
      "excerpt": "Un repere simple pour savoir quel outil utiliser selon ce que vous voulez faire.",
      "readTime": "5 min",
      "imagePath": "/images/pexels-kampus-7983616.jpg",
      "intro": "Tous les outils IA ne servent pas au meme travail. Le plus utile est de choisir l'outil selon votre besoin du moment.",
      "sections": [
        {
          "title": "1. Pour commencer vite",
          "body": "ChatGPT est pratique pour commencer un texte, trouver des idees ou reformuler rapidement."
        },
        {
          "title": "2. Pour relire un texte long",
          "body": "Claude peut aider quand vous avez un document long a relire ou a rendre plus clair."
        },
        {
          "title": "3. Pour verifier une information",
          "body": "Perplexity est utile quand vous voulez retrouver des sources ou verifier un point avant de l'utiliser."
        }
      ],
      "takeaway": "Le bon outil depend de la tache, pas de la mode."
    },
    {
      "id": "document-structure",
      "category": "Documents",
      "title": "Rendre un document plus clair",
      "excerpt": "Avant la mise en page finale, il faut d'abord avoir une structure simple et propre.",
      "readTime": "6 min",
      "imagePath": "/images/pexels-fauxels-3184291.jpg",
      "intro": "Un document devient vite difficile a lire si les titres, le plan et les pages ne sont pas bien organises.",
      "sections": [
        {
          "title": "1. Avoir des titres clairs",
          "body": "Si chaque titre est different, le document devient confus. Il faut garder la meme logique du debut a la fin."
        },
        {
          "title": "2. Garder un plan simple",
          "body": "Si les parties se repetent ou changent tout le temps, la lecture devient difficile. Un bon plan aide tout le document."
        },
        {
          "title": "3. Verifier les pages et le sommaire",
          "body": "Le sommaire et les pages doivent suivre la meme logique. Sinon le document parait vite mal fini."
        }
      ],
      "takeaway": "Un document propre commence par un plan clair."
    },
    {
      "id": "securite-documents-ia",
      "category": "Securite",
      "title": "Partager un document sans prendre de risque",
      "excerpt": "Quelques verifications simples avant d'envoyer un document a corriger ou a relire.",
      "readTime": "5 min",
      "imagePath": "/images/pexels-kampus-7551617.jpg",
      "intro": "Avant d'envoyer un document, il faut verifier qu'il ne contient pas plus d'informations que necessaire.",
      "sections": [
        {
          "title": "1. Enlever le trop personnel",
          "body": "Retirez ou cachez ce qui n'est pas utile: mots de passe, donnees bancaires, numeros sensibles ou commentaires internes."
        },
        {
          "title": "2. Dire ce que vous attendez",
          "body": "Dites si vous voulez une correction, une mise en page ou un accompagnement. Cela evite d'envoyer trop de choses."
        },
        {
          "title": "3. Relire avant d'envoyer plus loin",
          "body": "Si une IA aide a reformuler un texte, il faut toujours relire avant un envoi final."
        }
      ],
      "takeaway": "Le bon reflexe est simple: envoyer seulement ce qui est utile."
    }
  ],
  "faq": [
    {
      "question": "Prometheus fait a ma place ou explique aussi ?",
      "answer": "Les deux. Vous pouvez demander une correction, une aide directe ou une vraie explication pas a pas."
    },
    {
      "question": "Comment se passe le paiement ?",
      "answer": "Vous envoyez d'abord votre demande. Ensuite, vous recevez un devis simple ou une proposition de creneau."
    },
    {
      "question": "Peut-on envoyer un document sensible ?",
      "answer": "Oui, mais seulement si c'est utile. Le mieux est d'enlever ce qui est trop personnel avant l'envoi."
    },
    {
      "question": "Les formations sont-elles disponibles immediatement ?",
      "answer": "Une partie est visible tout de suite. Le reste s'ouvre apres validation de la formule choisie."
    }
  ]
};
